...
\item \textbf{Data Engineering \& Analysis}: Python (pandas, NumPy, scikit-learn), SQL, ETL pipelines, data modelling, statistical analysis.
...
\item \textbf{Systems Modelling}: Geospatial analysis (OpenStreetMap, GIS), optimisation modelling, simulation modelling, renewable energy potential assessment.
